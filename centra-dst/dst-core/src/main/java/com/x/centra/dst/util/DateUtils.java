...
public class DateUtils {
	...
	* @throws
	...
	public static Timestamp getTimeByUnit(Timestamp startTime, String timeUnit, int timeValue){
		 ...
		 if(StringUtils.equals(DiscountConstants.TimeUnit.HOUR, timeUnit)){
			 calendar.add(Calendar.HOUR, timeValue);
		 }else if(StringUtils.equals(DiscountConstants.TimeUnit.DAY, timeUnit)){
			 calendar.add(Calendar.DATE, timeValue);
		 }else if(StringUtils.equals(DiscountConstants.TimeUnit.WEEK, timeUnit)){
			 calendar.add(Calendar.DATE, timeValue*7);
		 }else if(StringUtils.equals(DiscountConstants.TimeUnit.MONTH, timeUnit)){
			 calendar.add(Calendar.MONTH, timeValue);
		 }else if(StringUtils.equals(DiscountConstants.TimeUnit.QUARTER, timeUnit)){
			 calendar.add(Calendar.MONTH, timeValue*3);
		 }else if(StringUtils.equals(DiscountConstants.TimeUnit.YEAR, timeUnit)){
