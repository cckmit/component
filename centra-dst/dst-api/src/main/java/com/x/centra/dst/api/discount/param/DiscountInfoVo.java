...
public class DiscountInfoVo implements Serializable{
     ...
     * 级别（可选）
     */
    private DiscountLevelVo levelVo;
    
    /**
     * 权益主体限定关系（可选）
     */
    private List<DiscountOwnerLimitVo> limitVos;
	...
	public DiscountLevelVo getLevelVo() {
		return levelVo;
	}

	public void setLevelVo(DiscountLevelVo levelVo) {
		this.levelVo = levelVo;
	}

	public List<DiscountOwnerLimitVo> getLimitVos() {
		return limitVos;
	}

	public void setLimitVos(List<DiscountOwnerLimitVo> limitVos) {
