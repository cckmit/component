			...
			$("#keyAttrDiv .word3").each(function(i){
				...
				switch (valWay){
					...
					case '2'://多选
						...
						break;
					case '3'://单行输入
						val = $("#keyAttrDiv input[attrId='keyAttr"+attrId+"'")[0].value;
						attrValArray.push({'attrId':attrId,'attrValId':'','attrVal':val,'attrVal2':''});
						break;
					case '4'://多行输入
						val = $("#keyAttrDiv textarea[attrId='keyAttr"+attrId+"'")[0].value;
						attrValArray.push({'attrId':attrId,'attrValId':'','attrVal':val,'attrVal2':''});
						break;
		...
		_convertSaleAttr:function(){
			...
			$("#saleAttrDiv .word3").each(function(i){
				...
				case '2'://多选
					...
					break;
				case '3'://单行输入
					val = $("#saleAttrDiv input[attrId='saleAttr"+attrId+"'")[0].value;
					attrValArray.push({'attrId':attrId,'attrValId':'','attrVal':val,'attrVal2':''});
					break;
				case '4'://多行输入
					val = $("#saleAttrDiv textarea[attrId='saleAttr"+attrId+"'")[0].value;
					attrValArray.push({'attrId':attrId,'attrValId':'','attrVal':val,'attrVal2':''});
					break;
