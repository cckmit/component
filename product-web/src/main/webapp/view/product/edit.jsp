<%@ page import="com.x.sdk.component.idps.IDPSClientFactory" %>
<%@ page import="com.x.sdk.component.idps.IImageClient" %>
<%@ page import="com.x.centra.product.web.constants.SysCommonConstants" %>
						...
						<div id="imgDiv" class="form-label bd-bottom"><!--查询条件-->
							...
							<ul>
								<li class="width-xlag pl-40">
									提示：请上传商品主体正面照片jpg/png格式，不小于300x200px的方形图片，单张不能超过3M，最多6张。
								</li>
							</ul>
							<%
												...
												<p class="img">
													<c:choose>
														<c:when test="${valInd<attrValSize && attrValPic.get(valInd)!=null}">
															...
															<%-- <img src="<c:out value='${_base}/home/displayPic?id=${valInfo.vfsId}&type=${valInfo.picType}' />" imgId="${valInfo.vfsId}" --%>
