...
import com.x.centra.product.api.product.param.ProdAttrValInfo;
import com.x.centra.product.api.product.param.ProdAudiencesInfo;
import com.x.centra.product.api.product.param.ProdNoKeyAttr;
import com.x.centra.product.api.product.param.ProdPicInfo;
import com.x.centra.product.api.product.param.ProductInfo;
import com.x.centra.product.api.product.param.ProductInfoForUpdate;
...
import com.x.centra.product.web.model.product.ProductEditInfo;
...
public class ProdEditController {
    ...
    public ResponseData<String> saveProductInfo(
        ...
        if (StringUtils.isNotBlank(detailConVal)){
            String detailConValDe;
        	try {
				detailConValDe = URLDecoder.decode(detailConVal, "utf-8");
			} catch (UnsupportedEncodingException e) {
				throw new SystemException("内容转换失败", e); 
			}
        	fileId = client.insert(detailConValDe);
        }
