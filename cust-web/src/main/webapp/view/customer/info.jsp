						...
						<div class="main-box clearfix">
							...
							<div class="main-box-body clearfix">
								...
								<div class="form-label  bd-bottom">
									<ul class="big-word">
										<li class="col-md-12">
											<p class="word3" style="width:200px;">客户ID：</p>
											<p id="custId" style="width:200px;">${custId}</p>
											
											<p class="word3" style="width:200px;">客户姓名：</p>
											<p style="width:200px;">${custFullInfo.custName}</p>
										</li>
									</ul>
									<%-- <ul class="big-word">
										<li class="col-md-12">
									...
									<ul>
										<li class="col-md-12">
											<p class="word3" style="width:200px;">客户手机号码：</p>
											<p style="width:200px;height:30px;">${custFullInfo.custPhoneNum}</p>
											
											<p class="word3" style="width:200px;">认证状态：</p> <c:if
									...
									<ul>
										<li class="col-md-12">
											<p class="word3" style="width:200px;">状态变更时间：</p>
											<p style="width:200px;">${stateChgTime}</p>
											
											<p class="word3" style="width:200px;">创建时间：</p>
											<p>${createTime}</p>
										</li>
									</ul>
									<%-- <ul>
									...
									<c:if test="${custFullInfo.certInfo != null }">
											<ul>
												<li class="col-md-12">
													<p class="word3" style="width:200px;">证件类型：</p> 
													<c:if test="${custFullInfo.certInfo.certType == '01' }">
														<p style="width:200px;">身份证</p>
													</c:if>
													
													<p class="word3" style="width:200px;">证件号码：</p> 
									...
									<ul>
										<li class="col-md-12">
											<p class="word3" style="width:200px;">锁定状态：</p> <c:if
												test="${custFullInfo.lockStatus == 0 }">
												<p style="width:200px;">未锁定</p>
											</c:if> <c:if test="${custFullInfo.lockStatus == 1 }">
												<p style="width:200px;">锁定</p>
											</c:if>
										
											<p class="word3" style="width:200px;">锁定原因：</p>
